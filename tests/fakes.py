...
def is_grade_prompt(blob: str) -> bool:
    return (
        "Judge whether a chunk supports" in blob
        or "Judge support for the specific sub-question" in blob
        or "specific sub-question(s) this chunk covers" in blob
    )
